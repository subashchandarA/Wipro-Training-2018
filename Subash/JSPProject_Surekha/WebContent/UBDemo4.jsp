...
<jsp:setProperty property="candID" name="obj" param="txtID"/>
<jsp:setProperty property="candName" name="obj" param="txtName"/>
<jsp:setProperty property="course" name="obj" param="txtCourse"/>
<pre>
